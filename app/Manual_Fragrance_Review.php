 ...
 * @property User $user
 */
class Manual_Fragrance_Review extends Model
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'manual_fragrance_review';
     ...
     * @var array
     */
    protected $fillable = ['users_id', 'location_id', 'fragrance_id', 'created_at', 'updated_at', 'suitability', 'temp_avg', 'hum_avg', 'dew_point_avg', 'uv_index_avg', 'temp_feels_like_avg', 'atm_pressure_avg', 'clouds_avg', 'visibility_avg', 'wind_speed_avg', 'rain_avg', 'snow_avg', 'weather_main', 'weather_description', 'deleted_at'];
