...
const ProjectCategory = ({ projects, handleClick, active, focused, shiftLeft, isLast, category }) => {
    ...
    return (
        <div className={classes} style={item({ focused, active, shiftLeft })}>
            ...
            >
                <div className="category--image" style={background({ thumbnail, active })} />
            </div>
...
var projects1 = shuffle(projectCollection.slice());
var projects2 = shuffle(projectCollection.slice());
var projects3 = shuffle(projectCollection.slice());
var projects4 = shuffle(projectCollection.slice());
var projects5 = shuffle(projectCollection.slice());
