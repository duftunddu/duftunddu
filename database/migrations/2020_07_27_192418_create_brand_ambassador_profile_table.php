...
class CreateBrandAmbassadorProfileTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('brand_ambassador_profile', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('brand_ambassador_profile');
    }
}
