...
<link href="{{ asset('css/feature_slider_webstore_proposal.css') }}" rel="stylesheet">
        ...
        <li>
            <a class="active" href="#tabs-1">
                <div class="tag">
                    ...
                    <span class="heading">Add your online store to Duft Und Du</span>
                </div>
            </a>
            <div class="addon fadein">
                <span>
                    Allow your customers to get Personalized Fragrance Reviews right from your website.
                </span>
            </div>
        </li>
        <li>
