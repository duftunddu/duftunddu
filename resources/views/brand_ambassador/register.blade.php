                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="brand_id" type="number" class="form-control @error('brand_id') is-invalid @enderror" name="brand_id" value="{{ old('brand_id')}}">
                        ...
                        <div class="form-group row">
                                <label for="brand_not_found" class="col-md-4 col-from-label text-md-right">{{ __('If your brand is not in the list, check this:')}}</label>
                        ...
                        <div class="form-group row" id="showthis" name="showthis">
                                <label for="name" class="col-md-4 col-from-label text-md-right">{{ __('New Brand Name:')}}</label>
                                
                                <div class="col-md-6">
                                    <input id="name" type="text" placeholder="Brand Name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name')}}">
                        ...
                        {{-- Work Email --}}
                        <div class="form-group row">
                            <label for="email_work" class="col-md-4 col-form-label text-md-right">{{ __('Add your work email') }}</label>
                            
                            <div class="col-md-6">
                                <input id="email_work" type="email" placeholder="xyz@organization.com" class="form-control @error('email_work') is-invalid @enderror" name="email_work" value="{{ old('email_work') }}">
                                @error('email_work')
                        ...
                        {{-- LinkedIn --}}
                        <div class="form-group row" >
                                <label for="linkedin" class="col-md-4 col-from-label text-md-right">{{ __('LinkedIn Account:')}}</label>
                                <div class="col-md-6">
                                    <input id="linkedin" type="url" pattern="https?://www.linkedin.com.*" placeholder="https://www.linkedin.com/in/xyz" class="form-control @error('linkedin') is-invalid @enderror" name="linkedin" value="{{ old('linkedin')}}" required>
