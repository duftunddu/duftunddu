                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('brand_entry_admin')}}">
                            ...
                            {{-- Origin --}}
                            <div class="form-group row">
                                <label for="origin_id" class="col-md-4 col-from-label text-md-right">{{ __('Origin:')}}</label>

                                <div class="col-md-6">
                                    
                                    <select id="origin_id" type="number" class="form-control @error('origin_id') is-invalid @enderror" name="origin_id" value="{{ old('origin_id')}}" required>
