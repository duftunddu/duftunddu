...
<img src="{{ asset('images/for_emails/ambassador_proposal_edit.png') }}" alt="Ambassador Proposal" style="object-fit:contain; display:block; margin:auto; max-width:500px; height:auto;">
