        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- <div class="flex-grid"> --}}
                        {{-- <h4 for="about fragrance" class="col center color-highlight-purple">{{ __('Fragrance')}} </h4> --}}
                        <h4 for="&" class="col center">{{ __('&')}} </h4>
                        {{-- <h4 for="about you" class="col center color-red">{{ __('You')}} </h4><br> --}}
                    ...
                    <div class="row">
                        ...
                        <div class="column">
                            ...
                            <h4>Cost<span data-toggle="tooltip" data-placement="top" data-html="true"
                                title="This is an estimated cost.">*</span>:
                                {{$fragrance->cost}} {{$fragrance->currency}}
                        ...
                        <div class="column">
                            <div class="right">
                                ...
                                <h4 class="hsl-color" data-toggle="tooltip" data-placement="top" data-html="true"
                                    title="How long the fragrance lasts.<br>100 is max.">Longevity: {{$longevity}}</h4>
                                <!-- RATE -->
                                ...
                                <h4 class="hsl-color" data-toggle="tooltip" data-placement="top" data-html="true"
                                    title="Depends on season.<br>100 is average.<br>Above 100 is better.">Suitability:
                                    {{$suitability}}</h4>
                                <!-- RATE -->
                                <section class="rate rating">
                                    <!-- FIFTH STAR -->
                                ...
                                <h4 class="color-red"><a href="/login">Log In</a> / <a href="/register">Sign Up</a> to
                                    see if <span class="color-highlight-purple">{{ __($fragrance->name)}}</span> will
                                    suit you.</h4>
