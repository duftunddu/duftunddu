        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                    ...
                    <tbody>
                        ...
                        @foreach($brands as $brand) 
                            <tr>
                                ...
                                @auth
                                <td data-label="Vote">
                                    <button type="button" class="btn btn-outline-dark" name="{{$brand->name}}" id="{{$brand->name}}" onclick="handleVote(this.id);">
                                        {{ __('Vote') }}
                                    </button>
                                </td>
                                @endauth
                ...
                <div class="form-group row">
                    <div class="center">
                        <button type="button" class="btn btn-outline-dark" onclick="window.location='{{ url('/request_brand/') }}'">
                            {{ __('Add New Brand') }}
                        </button>
                    </div>
                </div>
...
<script>
    function handleVote(brand) {
        $.ajax({
           type:'POST',
           url:'/vote_brand',
           data:{"_token": "{{ csrf_token() }}", value: 1, brand_name: brand },
