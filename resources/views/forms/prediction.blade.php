...
<link href="{{ asset('css/gradient_range_slider.css') }}" rel="stylesheet">
<script src="{{ asset('js/gradient_range_slider.js') }}" defer></script>
{{-- The gradient range slider function is provided by: https://codepen.io/egrucza/pen/LEoOQZ

{{-- a
<link href="{{ asset('css/custom_range_input_slider_with_labels.css') }}" rel="stylesheet">
<script src="{{ asset('js/custom_range_input_slider_with_labels.js') }}" defer></script>
{{-- The custom_range_input_slider_with_labels function is provided by: https://codepen.io/trevanhetzel/pen/rOVrGK?__cf_chl_jschl_tk__=b2750a81cf592662b2f681db8c4d4b2acbfa54f9-1583743607-0-AWxuf3uC1YZvmctAJb8twBOEQmfNk0gdYe5ebnm_1eN0diUO0toHZfPJpwvYppv27XUFQpngdJ25QckzU57eZliKLDcCbNkbeHMYmDQdBVyn88u4Ja9En8VHOg56MMxvDdN-FdQTpX-gNa3XFMhMxm-Rki4uTezHqCRYLpUNsUW1ys_Ddg8A3ssUJtjZVYFpDkU9ehAYt20xqAjxO-kp4Wd0WhWXUPJSVlZTRZFGTrWGrhbR4y8E-_gGaT2mX6wePCfLxRhFWrwxcP-oRrOhI4RBWPg3ZFkSCG5PK_4Lvpu7CxvJl1-95gUM7FxD6zG4cInqGqOshiWL5e7laL5AeXG7tQ5X57LvCFc0NL2bPxrn
a --}}
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            {{-- Profession --}}
                            <div class="form-group row">
                                <label for="profession" class="col-md-4 col-from-label text-md-right required">{{ __('Profession:')}}</label>
                            ...
                            {{-- Age --}}
                            <div class="form-group row">
                                <label for="age" class="col-md-4 col-from-label text-md-right required">{{ __('Age:')}}</label>
                            ...
                            {{-- Skin Type --}}
                            <div class="form-group row">
                                <label for="skin type" class="col-md-4 col-from-label text-md-right required">{{ __('Skin Type:')}}</label>
                            ...
                            {{-- Sweat --}}
                            <div class="form-group row">
                                <label for="sweat" class="col-md-4 col-from-label text-md-right required">{{ __('How much do you sweat:')}}</label>

                                <div class="col-md-6">

                                    <input id="sweat" type="range" min="-100" max="0" value="0" class="range black" name="sweat" value="{{ old('sweat')}}" />

                                    {{-- <select id="sweat" type="sweat" class="form-control @error('sweat') is-invalid @enderror" name="sweat" value="{{ ('4')}}" required autocomplete="4">
                                    <option value="" selected="selected" disabled="disabled">-- Select Sweat Level --</option>
                                    <option value="1">
                                        {{'1'}}
                                    </option>
                                    <option value="2">
                            ...
                            {{-- Height --}}
                            <div class="form-group row">
                                <label for="height" class="col-md-4 col-from-label text-md-right required">{{ __('Height (in ft.):')}}</label>
                            ...
                            {{-- Body Shape --}}
                            <div class="form-group row">
                                <label for="body shape" class="col-md-4 col-from-label text-md-right required">{{ __('Body Shape:')}}</label>
                            ...
                            {{-- Climate --}}
                            <div class="form-group row">
                                <label for="climate" class="col-md-4 col-from-label text-md-right required">{{ __('Climate:')}}</label>
                            ...
                            {{-- Season --}}
                            <div class="form-group row">
                                <label for="season" class="col-md-4 col-from-label text-md-right required">{{ __('Season:')}}</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('fragrance_entry')}}">
                            ...
                            {{-- Note --}}
                            <div class="form-group row">
                                <label for="note" class="col-md-4 col-from-label text-md-right required">{{ __('Note:')}}</label>

                                <div class="col-md-6">

                                    <select id="note_id" type="text" class="form-control @error('note_id') is-invalid @enderror" name="note_id" value="{{ old('')}}" required>
                            ...
                            {{-- Strength --}}
                            <div class="form-group row">
                                <label for="strength" class="col-md-4 col-from-label text-md-right required">{{ __('Strength:')}}</label>
